...
$(document).on("click", ".js-bb-confirm-refresh", function () {
    var btn = this;

    bootbox.confirm({
        message: "Are you sure want to <b>Refresh</b>?",
        buttons: {
            confirm: {
                label: "Yes, refresh it!",
                className: "btn-brand"
            },
            cancel: {
                label: "Cancel",
...
$(document).on("click", ".js-bb-confirm-custom", function () {
    ...
    if ($(btn).data("btn-confirm") != null && $(btn).data("btn-confirm") !== "") {
        ...
        btnConfirm = { "label": "OK", "className": "btn-brand" };
    }
    ...
    if ($(btn).data("btn-cancel") != null && $(btn).data("btn-cancel") !== "") {
        ...
        btnCancel = { "label": "Cancel", "className": "btn-secondary" };
    }
