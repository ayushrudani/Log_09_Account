...
var UI_Select2 = function () {
    ...
    var handleSelect2_js = function () {
        var query = {};
        var $elements = $('.js-select2');
        ...
        if (modelplaceholderLength > 0) {
            // For Popup/Modal dropdown
            //dp = ".modal-body";
            dp = ".modal-body";
        } else {
            // For Normal page dropdown
            dp = "body";
        }

        $elements.select2({
            //dropdownParent: $('.modal-body'),
            //dropdownParent: $('#' + $('.js-select2').closest('.modal').attr('id')),
            //dropdownParent: $('.js-select2').closest('#modal-placeholder'),
